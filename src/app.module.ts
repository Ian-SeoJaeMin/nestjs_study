...
import { BearerTokenMiddleware } from './auth/middleware/bearer-token.middlewate';
            ...
            transports: [
                new winston.transports.Console({
                    format: winston.format.combine(
                        ...
                        winston.format.printf(info => `[${info.context}] ${info.timestamp} ${info.level} ${info.message}`)
                    )
                }),
